...
const main = async() => {
    try {
        ...
        globalThis.document.getElementById('overall-date').innerText = `${monthDisplay} ${data.year}`;
...
<div class="events-table-cell-location"><span class="events-table-cell-location-header">Location:</span> ${event.location || 'TBD'}</div>
